<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="ProductInfo.aspx.cs" Inherits="DarazEcommerce.Admin.ProductInfo" %>
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <asp:DropDownList ID="drpBrand" runat="server" CssClass="form-control" 
                    AutoPostBack="True" OnSelectedIndexChanged="drpBrand_SelectedIndexChanged">
                    <asp:ListItem Value="0">Select Category</asp:ListItem>
                </asp:DropDownList>
            </div>
            <div class="form-group">
                <label class="control-label">Model</label>
                <asp:DropDownList ID="drpModel" runat="server" CssClass="form-control">
                    <asp:ListItem Value="0">Select Category</asp:ListItem>
                </asp:DropDownList>
            </div>
            <div class="form-group">
