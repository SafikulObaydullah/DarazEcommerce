<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ShoppingCart.aspx.cs" Inherits="DarazEcommerce.ShoppingCart" %>
              ...
              >
                ...
                <ItemTemplate>
                            ...
                            <tr>
                                ...
                                <td>
                                     <asp:LinkButton ID="btnremove" runat="server" Text="remove" CommandArgument='<%#Eval("Product.Id") %>' CommandName="rem"  />
                                </td>
                            </tr>
