<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ShoppingSystem.Account.Login" Async="true" %>
            ...
            <section id="loginForm">
                <div class="form-horizontal">
                    <div class="row">
                     <div class="col">
                        <center>
                            <img src="../Images/login-Omega%20model.jpg" width="150" />
                        </center>
                     </div>
                  </div>
                     <div class="row">
