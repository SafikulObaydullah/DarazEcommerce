<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="ShoppingSystem.Account.Register" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <p class="text-danger">
     ...
     <div class="row">
                     <div class="col">
                        <center>
                            <img src="../Images/Register-Titan%20model.jpg" style="left:150px" width="150" />
                        </center>
                     </div>
                  </div>
                     <div class="row">
    ...
    <div class="form-horizontal">
      ...
      <div class="row">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="Password" placeholder="Password" CssClass="col-md-2 control-label">Password</asp:Label>
            <div class="col-md-10">
